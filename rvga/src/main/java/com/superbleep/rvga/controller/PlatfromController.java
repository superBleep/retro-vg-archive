...
public class PlatfromController {
    ...
    @Operation(summary = "Register a new platform", description = "Register a new platform, sent in the request body")
    @ApiResponses(value = {
    ...
    @Operation(summary = "Get all platforms", description = "Returns all the platforms present in the database, " +
            "as a list. The list can be empty if there are no platforms.")
    ...
    @Operation(summary = "Get platform by id", description = "Return a specific platform from the database by its id")
    ...
    @Operation(summary = "Modify platform data", description = "Modify a platform's data. If some of the fields " +
            "are null, they will be replaced with their old values")
    @Parameter(name = "id", description = "Platform's id")
    @ApiResponses(value = {
    ...
    public ResponseEntity<Object> modifyData(@PathVariable Long id, @Valid @RequestBody PlatformPatch newPlatform) {
    ...
    @Operation(summary = "Delete a platform", description = "Remove a platform from the database by its id")
    @Parameter(name = "id", description = "Platform's id")
    @ApiResponses(value = {
