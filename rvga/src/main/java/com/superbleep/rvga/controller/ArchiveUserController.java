...
public class ArchiveUserController {
    ...
    @Operation(
            ...
            description = "Register a new user, sent in the request body"
    )
    @ApiResponses(value = {
    ...
    @Operation(
            ...
            description = "Returns all the users present in the database, as a list. The list can be empty if there are no users."
    )
    ...
    @Operation(
            ...
            description = "Return a specific user from the database by its id"
    )
    @Parameter(
            name = "id",
    ...
    @Operation(
            ...
            description = "Modify a user's data, except its password, role, and generated fields. If some of the fields are null, they will be replaced with their old values"
    )
    @Parameter(
            name = "id",
            description = "User's id"
    ...
    @Operation(
            ...
            description = "Remove a user from the database by its id"
    )
    @Parameter(
            name = "id",
            description = "User's id"
