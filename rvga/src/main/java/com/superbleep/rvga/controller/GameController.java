...
public class GameController {
    ...
    @Operation(summary = "Get all games", description = "Returns all the games present in the database, as a list. " +
            "The list can be empty if there are no games. Platform data not included.")
    ...
    @Operation(summary = "Get game by id", description = "Return a specific game from the database by its id. " +
            "Platform data inclusion optional")
    @Parameters(value = {
    ...
    @Operation(summary = "Modify game data", description = "Modify a game's data. If some of the fields are null," +
            " they will be replaced with their old values")
    @Parameter(name = "id", description = "Game's id")
    @ApiResponses(value = {
    ...
    public ResponseEntity<Object> modifyData(@PathVariable Long id, @Valid @RequestBody GamePatch newGame) {
    ...
    @Operation(summary = "Delete a game", description = "Remove a game from the database by its id")
    @Parameter(name = "id", description = "Game's id")
    @ApiResponses(value = {
